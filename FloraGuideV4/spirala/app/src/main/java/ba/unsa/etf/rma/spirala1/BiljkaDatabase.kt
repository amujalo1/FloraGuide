...
@TypeConverters(MedicinskaKoristConverter::class, ProfilOkusaBiljkeConverter::class, StringListConverter::class, KlimatskiTipConverter::class, ZemljisteConverter::class, BitmapConverter::class)
