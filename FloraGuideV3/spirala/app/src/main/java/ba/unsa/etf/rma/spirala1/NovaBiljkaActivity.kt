...
import ba.unsa.etf.rma.spirala1.BiljkeStaticData.dodajBiljku
...
class NovaBiljkaActivity : AppCompatActivity(), CoroutineScope{
    ...
    private fun dodajBiljku() {
        ...
        launch {
            ...
            biljkeStaticData.dodajBiljku(fixedBiljka)
            Log.d("NovaBiljkaActivity", "Broj biljaka nakon dodavanja: ${biljkeStaticData.getBiljke().size}")
